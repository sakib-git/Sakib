...
<div id='home'>
      ...
      <section id="home" className="relative px-6 md:px-12 py-24 lg:py-32 max-w-7xl mx-auto overflow-hidden">
      
      {/* Background Decor (Halka color touch) */}
        ...
        <div className="space-y-8 animate-fadeIn">
         ...
         Available for opportunities
            ...
            <p className="text-slate-600 dark:text-slate-400 text-xl leading-relaxed max-w-lg">
              Full-Stack Developer specializing in <span className="text-slate-900 font-medium">React & MERN Stack.</span> Building digital products with precision and passion.
            </p>
          </div>
 ...
 <div className="mt-4 text-center w-fit ">
        ...
        <div className="relative flex justify-center lg:justify-end">
          <div className="relative w-72 h-72 md:w-80 md:h-80 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-600 to-purple-600 rounded-3xl rotate-6 group-hover:rotate-12 transition-transform duration-500 opacity-20"></div>
